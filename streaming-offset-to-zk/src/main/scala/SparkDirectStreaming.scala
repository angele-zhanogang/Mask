...
object SparkDirectStreaming {
  ...
  val log: Logger = org.apache.log4j.LogManager.getLogger("SparkDirectStreaming")
  ...
  def createStreamingContext():StreamingContext={
    ...
    val sparkConf: SparkConf =new SparkConf().setAppName("Direct Kafka Offset to Zookeeper")
